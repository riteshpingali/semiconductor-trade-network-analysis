...
- **Source:** [UN Comtrade](https://comtradeplus.un.org/) bilateral trade data, HS codes 8541, 8542 and 8486 (semiconductor devices, integrated circuits, and semiconductor manufacturing equipment)
...
![Betweenness centrality across sub-periods](figures/betweenness_four_periods.png)

![Share of semiconductor imports sourced from China](figures/china_import_share_heatmap.png)

![Full analysis dashboard](figures/semiconductor_analysis.png)
...
├── figures/
│   ├── betweenness_four_periods.png
│   ├── china_import_share_heatmap.png
│   └── semiconductor_analysis.png
├── china_import_share.csv             # Derived output: China's share of partners' imports (%)
├── README.md
...
[LinkedIn](https://www.linkedin.com/in/ritesh-pingali-ba354828a)
